...
use wayland_protocols::wp::virtual_keyboard::zv1::client::zwp_virtual_keyboard_manager_v1::ZwpVirtualKeyboardManagerV1;
...
impl Dispatch<wayland_protocols::wp::virtual_keyboard::zv1::client::zwp_virtual_keyboard_v1::ZwpVirtualKeyboardV1, ()> for WlrState {
    fn event(
        _state: &mut Self,
        _proxy: &wayland_protocols::wp::virtual_keyboard::zv1::client::zwp_virtual_keyboard_v1::ZwpVirtualKeyboardV1,
        _event: <wayland_protocols::wp::virtual_keyboard::zv1::client::zwp_virtual_keyboard_v1::ZwpVirtualKeyboardV1 as wayland_client::Proxy>::Event,
        _data: &(),
        _conn: &Connection,
        _qhandle: &QueueHandle<Self>,
    ) {
